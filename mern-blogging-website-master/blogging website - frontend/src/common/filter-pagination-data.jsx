...
//         // Check if state.results is an array before concatenating
//         const resultsArray = Array.isArray(state.results) ? state.results : [];
//         obj = { ...state, results: [...resultsArray, ...data], page: page };
//     } else {
//         try {
